...
# Updated positions for visibility on 600px screen
status_y_position = 540
camera_button_rect = pygame.Rect(screen_width - 160, 540, 140, 40)
...
try:
    while running:
        ...
        # Draw arrows
        draw_arrow(screen, [(512, 330), (472, 400), (552, 400)], BLUE)  # Up
        draw_arrow(screen, [(200, 440), (280, 410), (280, 470)], BLUE)  # Left
        draw_arrow(screen, [(824, 440), (744, 410), (744, 470)], BLUE)  # Right

        # Move UI up to avoid cutoff
        status_y_position = 500
        camera_button_rect = pygame.Rect(screen_width - 160, 500, 140, 40)

        # Bottom panel bar
        #pygame.draw.rect(screen, (220, 220, 220), (0, 490, screen_width, 60))

        # Status text
        status_surface = font.render(f"Status: {current_status}", True, (0, 0, 0))
        screen.blit(status_surface, (20, status_y_position + 10))
